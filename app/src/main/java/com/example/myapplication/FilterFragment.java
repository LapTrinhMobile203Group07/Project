...
public class FilterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.filter_picture_fragment, container, false);
        ...
        btnClearFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((EditPhoto) context).onMsgFromFragToEdit("FILTER", "CLEAR", null);
            }
        });
        ...
        btnCheckFilter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((EditPhoto) context).onMsgFromFragToEdit("FILTER", "CHECK", null);
            }
        });
