...
public class PicturesFragment extends Fragment implements FragmentCallbacks{
    ...
    public static PicturesFragment newInstance(Context context, String pathFolder, String type){
        PicturesFragment fragment = new PicturesFragment(context,pathFolder,type);
        return fragment;
    }
